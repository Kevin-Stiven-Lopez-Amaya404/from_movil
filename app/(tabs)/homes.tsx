...
export default function HomesScreen() {
  ...
  const openedHome =
    homes.find((home) => home.id === resolvedOpenedHomeId) ?? null;
  ...
  function turnOffHome() {
    homeDevices
      ...
      .forEach((device) => setDeviceOnline(device.id, false));
    Alert.alert(
      "Hogar apagado",
      `Se apagaron los dispositivos de ${activeHome?.name ?? "este hogar"}.`,
    );
  }
      ...
      <>
            ...
            return (
              ...
              >
                ...
                <Switch
                  ...
                  accessibilityLabel={`Cambiar conectividad de ${device.name}`}
                  trackColor={{
                    false: "#CDD2E4",
                    true: "#BDE8CB",
                  }}
        ...
        {!!homeDevices.length && (
          <Pressable
            style={({ pressed }) => [
              styles.offButton,
              pressed && styles.offButtonPressed,
            ]}
            onPress={turnOffHome}
          >
